...
import frc.robot.commands.UDPCommands;
...
public class RobotContainer
{
  ...
  public static AutoTrain AutoTrain;
  ...
  public RobotContainer() 
  {
    ...
    AutoTrain = new AutoTrain();
    oms = new OMS();
    oi = new OI();
    udp = new UDP();

    //Set default command for the drive train subsystem
    AutoTrain.setDefaultCommand(new Teleop());
    oms.setDefaultCommand(new TeleopOMS());
    udp.setDefaultCommand(new UDPCommands());
  }

  public Command getAutonomousCommand()
  {
    String mode = autoChooser.getSelected();
    return autoMode.getOrDefault(mode, new Auto());
  }
